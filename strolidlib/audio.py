"""Helpers for loading audio tensors from vCons.

This module is copied from the tensor_manager package so components can load
audio consistently without depending on that service directly.
"""
